var self = module.exports = {
  ...
  isNode: () => {
    try {
      if (module.exports = typeof process === 'object' && Object.prototype.toString.call(process) === '[object process]') { return true }
      return false
    } catch (e) {
      return false
    }
  ...
  merge: (obj1, obj2) => {
    for (var p in obj2) {
      try {
        if (obj2[p].constructor == Object) { obj1[p] = self.merge(obj1[p], obj2[p]) } else { obj1[p] = obj2[p] }
